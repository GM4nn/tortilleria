...
class SaleTab(ttk.Frame):
    """Individual tab for a sale in progress"""

    def __init__(self, parent, app, tab_manager):
        super().__init__(parent)
        self.app = app
        self.tab_manager = tab_manager  # Reference to the tab container
    ...
    def charge(self):
        ...
        # Always use Customer Counter for direct sales
        ...
        if success:
            ...
            # Close this tab after charging if there is more than one
